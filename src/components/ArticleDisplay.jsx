    ...
    return (
      !this.props.loggedIn ? <p>You must be logged in to view articles</p>
        ...
        <main className="articleDisplay">
          ...
          <div className="user" >
            <img src={created_by.avatar_url} alt="user avatar" className="articleImg"></img>
          ...
          <Comments articleId={_id} user={this.props.user} commentCount={comment_count} className="comments" />
